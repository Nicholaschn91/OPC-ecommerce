# Track B — Memorial & Healing

> **赛道代号**: B
> **赛道名称**: Memorial & Healing
> **版本**: V1.0
> **更新**: 2026-07-13
...
| 维度 | 定义 |
|------|------|
| **核心品类** | 纪念品 / 骨灰盒 / 宠物/人物纪念类 |
| **核心动机** | 哀悼 / 缅怀 / 情感疗愈 |
| **核心情感** | 情绪基调肃穆 / 用户处于失去状态 |
| **典型 SPU** | 宠物骨灰盒、定制纪念相框、树葬套装 |

---

## 2. 选轨锚点

### 快速排除清单（命中即锁定 Track B）
- SPU 含 "memorial / urn / ashes / cremation / remembrance / sympathy / condolence" + 家居/饰品载体 → **直接锁定 Track B**（规则 B2）
- 品类为纪念品/骨灰盒，且无 A/B4 信号 → **默认 Track B**

### 仲裁规则
- **B2 哀悼意图覆盖软家居**: 品类命中 Track K 且同时存在哀悼/纪念购买动机信号 → **强制升轨至 Track B**
- **B4 定制纪念+软家居+无A/B3**: 品类为定制纪念品，无庆典/婴儿信号 → **默认 Track B**
...
| T_XX | 根据 USP 与象限动态选择 | Track B 策略文档中战术库中选择 |
...
| 编号 | 禁令 | 说明 |
|------|------|------|
| **M1** | **品牌色限制** | Track B 肃穆色系强制，品牌色仅允许出现在 A+ Hotspot 徽章边框、Mod5/Mod6 文字色或极简线条装饰 |
| **M2** | **饱和度上限** | 饱和度 ≤ 65%，禁用高饱和霓虹色 |
| **M3** | **禁用场景** | 派对、婚礼现场、开箱仪式、庆典场景 |
...
META:
  赛道代号: Track_B
  选轨置信度: HIGH
  选轨依据: "B2规则直接锁定 — memorial urn + home decor + 无A/B3信号"
  边界风险: "与Track_K存在品类重叠，已由B2规则升轨"
```
...
*本文档为 Track B 专属规范，不可跨赛道引用。如有冲突，以本文档为准。*