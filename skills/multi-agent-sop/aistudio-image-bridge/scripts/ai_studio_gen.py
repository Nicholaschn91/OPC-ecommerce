...
def main():
    ...
    # 1. 导航到 AI Studio
    commands.append({
        "tool": "mcp__browser_aistudio__browser_navigate",
        "args": {
    ...
    # 2. 等待页面加载
    commands.append({
        "tool": "mcp__browser_aistudio__browser_wait_for",
        "args": {"time": 3}
    })
    ...
    if args.image_only:
        commands.append({
            "tool": "mcp__browser_aistudio__browser_evaluate",
            "args": {
    ...
    # 5. 点击 Run
    commands.append({
        "tool": "mcp__browser_aistudio__browser_click",
        "args": {
            "element": "Run button",
