...
**完整维护手册见 `handoff/MAINTAINERS.md`。**

维护权边界：
- **SOP 流程、Agent 定义、数据清洗工具链、Hermes 配置、Agnes/图片后处理** → **home-hermes 主导**
- **关键词治理、HiCustom/1688 采集、GLM-5.2 语义层、Tabbit 上传** → **home-workbuddy 领先**（工具成熟后再交接）
- **home-hermes 通过 GitHub commit message 或本文件通告重大变更**（SOP 版本更新、工具推进状态、Agent 边界重定）
